// ================================================================
// CircularGallery.jsx — WebGL Curved Horizontal Gallery (OGL)
// Adapted for Distribuidora CENIT — JavaScript version (no TS)
// ================================================================
...
function createTextTexture(gl, text, font = 'bold 28px Inter, sans-serif', color = 'white') {
...
class Title {
  constructor({ gl, plane, renderer, text, textColor = '#ffffff', font = 'bold 28px Inter, sans-serif' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class Media {
  ...
  update(scroll, direction) {
    ...
    // uTime removed — was causing image trembling
...
class App {
  constructor(container, { items, bend, textColor = '#ffffff', borderRadius = 0.05, font = 'bold 28px Inter, sans-serif', scrollSpeed = 2, scrollEase = 0.05 } = {}) {
  ...
  createRenderer() {
    this.renderer = new Renderer({ alpha: true, antialias: true, dpr: 1 });
